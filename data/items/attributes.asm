...
; NEST BALL
	item_attribute 1000, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; NET BALL
	item_attribute 700, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; DIVE BALL
	item_attribute 700, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; LUXURY BALL
	item_attribute 350, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; HEAL BALL
	item_attribute 350, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; QUICK BALL
	item_attribute 1000, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
...
; CHERISH BALL
	item_attribute 1000, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; POTION
	item_attribute 350, 0, 25, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; SUPER POTION
...
; ANTIDOTE
	item_attribute 500, 0, 1 << PSN, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; BURN HEAL
	item_attribute 500, 0, 1 << BRN, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; PARLYZ HEAL
	item_attribute 500, 0, 1 << PAR, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; AWAKENING
	item_attribute 100, 0, SLP, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; ICE HEAL
	item_attribute 1000, 0, 1 << FRZ, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; FULL HEAL
	item_attribute 400, 0, -1, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; FULL RESTORE
...
; ETHER
	item_attribute 400, 0, 20, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; MAX ETHER
	item_attribute 1500, 0, 40, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; ELIXIR
	item_attribute 300, 0, 10, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; MAX ELIXIR
	item_attribute 3500, 0, 20, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; HP UP
...
; PP MAX
	item_attribute 10000, 0, 0, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; FRESH WATER
	item_attribute 200, 0, 30, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; SODA POP
	item_attribute 300, 0, 50, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; LEMONADE
	item_attribute 500, 0, 80, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; MOOMOO MILK
	item_attribute 500, 0, 100, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; RAGECANDYBAR
	item_attribute 500, 0, -1, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; PEWTERCRUNCH
	item_attribute 500, 0, -1, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; SACRED ASH
	item_attribute 50000, 0, 0, MEDICINE, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; ENERGYPOWDER
	item_attribute 500, 0, 80, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ENERGY ROOT
	item_attribute 900, 0, 120, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; HEAL POWDER
	item_attribute 200, 0, -1, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; REVIVAL HERB
	item_attribute 1500, 0, 0, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; X ATTACK
...
; REPEL
	item_attribute 400, 0, 150, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; SUPER REPEL
	item_attribute 600, 0, 200, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; MAX REPEL
	item_attribute 800, 0, 250, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; ESCAPE ROPE
	item_attribute 500, 0, 0, ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; # DOLL
	item_attribute 500, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; ABILITY CAP
	item_attribute 1000, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; LEAF STONE
...
; CHERI BERRY
	item_attribute 10, HELD_HEAL_STATUS, 1 << PAR, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CHESTO BERRY
	item_attribute 10, HELD_HEAL_STATUS, SLP, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PECHA BERRY
	item_attribute 10, HELD_HEAL_STATUS, 1 << PSN, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; RAWST BERRY
	item_attribute 10, HELD_HEAL_STATUS, 1 << BRN, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ASPEAR BERRY
	item_attribute 10, HELD_HEAL_STATUS, 1 << FRZ, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; LEPPA BERRY
	item_attribute 10, HELD_RESTORE_PP, -1, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ORAN BERRY
	item_attribute 10, HELD_BERRY, 10, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PERSIM BERRY
	item_attribute 10, HELD_HEAL_CONFUSE, 0, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LUM BERRY
	item_attribute 10, HELD_HEAL_STATUS, -1, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; SITRUS BERRY
	item_attribute 10, HELD_BERRY, 0, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; FIGY BERRY
	item_attribute 10, HELD_BERRY, 0, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; POMEG BERRY
...
; LIECHI BERRY
	item_attribute 10, HELD_RAISE_STAT, ATTACK, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; GANLON BERRY
	item_attribute 10, HELD_RAISE_STAT, DEFENSE, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; SALAC BERRY
	item_attribute 10, HELD_RAISE_STAT, SPEED, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PETAYA BERRY
	item_attribute 10, HELD_RAISE_STAT, SP_ATTACK, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; APICOT BERRY
	item_attribute 10, HELD_RAISE_STAT, SP_DEFENSE, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; LANSAT BERRY
	item_attribute 10, HELD_RAISE_CRIT, 0, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; STARF BERRY
	item_attribute 10, HELD_RAISE_STAT, $10 | MULTIPLE_STATS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ENIGMA BERRY
	item_attribute 10, HELD_ENIGMA_BERRY, 0, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CUSTAP BERRY
	item_attribute 10, HELD_CUSTAP_BERRY, 0, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; JABOCA BERRY
	item_attribute 10, HELD_OFFEND_HIT, PHYSICAL, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ROWAP BERRY
	item_attribute 10, HELD_OFFEND_HIT, SPECIAL, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; KEE BERRY
	item_attribute 10, HELD_DEFEND_HIT, PHYSICAL, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; MARANGABERRY
	item_attribute 10, HELD_DEFEND_HIT, SPECIAL, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; BERRY JUICE
	item_attribute 200, HELD_BERRY, 20, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; SILK SCARF
...
; BRIGHTPOWDER
	item_attribute 1500, HELD_BRIGHTPOWDER, $9a, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SCOPE LENS
...
; SILVER LEAF
	item_attribute 1000, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; GOLD LEAF
	item_attribute 2500, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SLOWPOKETAIL
...
; OLD AMBER
	item_attribute 1000, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MULCH
	item_attribute 250, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SWEET HONEY
...
; LITEBLUEMAIL
	item_attribute 50, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PORTRAITMAIL
	item_attribute 10, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LOVELY MAIL
	item_attribute 50, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; EON MAIL
	item_attribute 50, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
