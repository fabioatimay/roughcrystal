	...
	db 4 percent, 4 percent, 4 percent ; encounKEE_BNO_ITEMERRYter rates: morn/day/nite
	; morn
	wildmon 21, ZUBAT
	wildmon 21, GOLBAT
	wildmon 21, ZUBAT
	...
	def_grass_wildmons ROUTE_29 ; route 1
	db 10 percent, 10 percent, 10 percent ; encounter rates: morn/day/nite
	; morn
	wildmon 2, SENTRET
	wildmon 2, SENTRET
	...
	wildmon 7, ODDISH
	wildmon 6, MAREEP
	wildmon 11, EKANS, ARBOK_JOHTO_FORM
	wildmon 6, SUNKERN
	wildmon 16, RATTATA
	; nite
	wildmon 4, HOOTHOOT
	...
	wildmon 6, GEODUDE
	wildmon 6, SANDSHREW
	wildmon 12, EKANS, ARBOK_JOHTO_FORM
	wildmon 7, SUNKERN
	wildmon 18, PIDGEY
	; day
	wildmon 6, RATTATA
	...
	wildmon 12, DROWZEE
	wildmon 12, HOOTHOOT
	wildmon 18, RATTATA, ALOLAN_FORM
	wildmon 10, DITTO
	wildmon 26, DROWZEE
	wildmon 10, DITTO
	wildmon 25, DITTO
